...
```sh
cargo install --list | rg '^imessage-tui v0.1.2:'
```
...
2. Create a tag matching the package version, such as `v0.1.2`, targeting
   `main`.
3. Use a title such as `imessage-tui 0.1.2` and summarize the release using
   `CHANGELOG.md`.
...
```sh
cargo install --git https://github.com/rsheyd/imessage-tui.git --tag v0.1.2
```
